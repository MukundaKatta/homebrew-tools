class BedrockOps < Formula
  include Language::Python::Virtualenv

  desc "Production-grade boto3 toolkit for AWS Bedrock"
  homepage "https://github.com/MukundaKatta/bedrock-ops"
  url "https://github.com/MukundaKatta/bedrock-ops/releases/download/v0.1.0/bedrock_ops-0.1.0.tar.gz"
  ...
  test do
    script = <<~PYTHON
      from bedrock_ops import BedrockClient, capabilities, TokenUsage
      assert capabilities("anthropic.claude-sonnet-4-20250514-v1:0").max_input_tokens == 200_000
    PYTHON
